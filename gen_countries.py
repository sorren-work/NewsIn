"""Country list for weather — import `pairs` or run: python gen_countries.py"""
import json
...
pairs = [
    ...
    ("CZ", "Czech Republic"), ("CD", "Democratic Republic of the Congo"), ("KP", "Democratic People's Republic of Korea"),
    ...
    ("KR", "South Korea"), ("RO", "Romania"), ("RU", "Russian Federation"), ("RW", "Rwanda"),
    ...
    ("SY", "Syrian Arab Republic"), ("TJ", "Tajikistan"), ("TH", "Thailand"), ("TL", "Timor-Leste"), ("TG", "Togo"),
    ("TO", "Tonga"), ("TT", "Trinidad and Tobago"), ("TN", "Tunisia"), ("TR", "Turkey"), ("TM", "Turkmenistan"),
    ("TV", "Tuvalu"), ("UG", "Uganda"), ("UA", "Ukraine"), ("AE", "United Arab Emirates"), ("GB", "United Kingdom"),
    ("TZ", "United Republic of Tanzania"), ("US", "United States"), ("UY", "Uruguay"), ("UZ", "Uzbekistan"),
    ("VU", "Vanuatu"), ("VE", "Venezuela"), ("VN", "Viet Nam"), ("YE", "Yemen"), ("ZM", "Zambia"), ("ZW", "Zimbabwe"),
    ("PS", "Palestine"), ("VA", "Holy See"),
]

if __name__ == "__main__":
    out = [{"code": c, "name": n} for c, n in pairs]
    out.sort(key=lambda x: x["name"].lower())
    with open("weather_countries.json", "w", encoding="utf-8") as f:
